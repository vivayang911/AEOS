...
process.env.AEOS_WALLET_HANDOFF_PATH = process.env.AEOS_WALLET_HANDOFF_PATH || resolve(__dirname, "../reports/live-demo/live-balance-observer-usc-wallet-handoff-v1.json");
process.env.AEOS_WALLET_SUBMISSION_PATH = process.env.AEOS_WALLET_SUBMISSION_PATH || resolve(__dirname, "../reports/live-demo/live-balance-observer-usc-wallet-submission-v1.json");
