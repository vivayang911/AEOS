...
Write-Output ([pscustomobject]@{ status='PASS'; sbom=$sbomPath; apiTests=361; apiSuites=90; webTests='19/19'; cockpitUi='PASS'; agentEval='21/21'; ragEval='5/5'; ragMemory='PASS'; decisionRetrieval='PASS'; evidenceClassification='PASS'; evidenceRequestBroker='PASS'; committeeEvidenceGapLineage='PASS'; evidenceAnchorHandoff='PASS'; evidenceAnchorConfirmation='PASS'; evidenceAnchorDeploymentPlan='PASS'; aeosEvidenceSourceDeploymentPlan='PASS'; policyRegistryDeploymentPlan='PASS'; treasuryGuardDeploymentPlan='PASS'; daoPolicyActivationBatch='PASS'; daoPolicyActivationReadback='PASS'; daoPolicyUnpauseHandoff='PASS'; treasuryPolicyBindingEngine='PASS'; multiTreasuryConcurrency='PASS'; treasuryRegistry='PASS'; adaptivePid='PASS'; governedSkills='PASS'; evidenceBoundPid='PASS'; treasuryOutcomes='PASS'; treasuryTransactionCosts='PASS'; counterfactualMethodologies='PASS'; counterfactualAssessments='PASS'; outcomeMemoryLifecycle='PASS'; databaseLogicalRestoreDrill='PASS'; eightAgentA2A='PASS'; tenantRlsTables=65; identityOrganization='PASS'; tenantRls='PASS'; organizationConfiguration='PASS'; commandSecurity='PASS'; requestTraceAudit='PASS'; transactionalOutbox='PASS'; deterministicAlerts='PASS'; periodicAnomalyProducers='PASS'; attestcoinReliability='PASS'; auditExports='PASS'; explorerLinks='PASS'; policyBacktests='PASS'; policyTransactionImpact='PASS'; governorVotingEvidence='PASS'; demoFixture='PASS'; contractTests='24/24'; contractBehaviorFuzz='23/23'; contractInvariants='5/5 x 64 runs x 4096 calls'; contractGasRegression='PASS'; contractSurface='VERIFIED'; evidenceAnchorSurface='VERIFIED'; aeosEvidenceSourceSurface='VERIFIED'; policyRegistrySurface='VERIFIED' } | ConvertTo-Json -Compress)
