...
| 00:14–00:31 | Judge Mode steps 01–03. Pause on `PROVES` and `DOES NOT PROVE`, then cut to the prepared Sepolia Etherscan observation tab. | "AEOS uses Attestcoin as its verification boundary. This project-owned Sepolia observation was canonically included, then covered by a frozen Merkle and continuity proof." |
| 00:31–00:48 | Cut to the prepared Creditcoin Blockscout `TransactionVerified` transaction. Keep status, hash and event/log area legible; no live search. | "Creditcoin's native BlockProver accepted the exact source transaction inclusion proof. AEOS verifies sender, target, calldata, zero value, canonical receipt and the TransactionVerified event before accepting it." |
...
3. `https://creditcoin-testnet.blockscout.com/tx/0x1011f237c21733a59472b82c7a14c01e79d99e23ffb3fba1ce4905655a4fb860`
4. `http://localhost:3000/evidence/ev_aa0b5dbc6fdf431aa6d9f20789c160bf`
5. `http://localhost:3000/decisions?decision=decision_8047c40b442940c8a1b2ea268681b990`
6. `https://creditcoin-testnet.blockscout.com/tx/0x181ab1d51085f845b76cdc5c4971622f550dafd33ed2e501dcc6c284c8bb9731`
7. `http://localhost:3000/governance`
8. `https://creditcoin-testnet.blockscout.com/tx/0xeecd79baabd81d23000ef36791384c1919615d8c4a609fc8215819c970c01160`
9. `http://localhost:3000/strategies`
10. `http://localhost:3000/knowledge`
11. `http://localhost:3000/skills`
12. `http://localhost:3000/verification`
...
3. Creditcoin `TransactionVerified`: `0x1011f237c21733a59472b82c7a14c01e79d99e23ffb3fba1ce4905655a4fb860`.
4. `EvidenceAnchorASC.verifyAndAnchor`: `0x181ab1d51085f845b76cdc5c4971622f550dafd33ed2e501dcc6c284c8bb9731`.
5. Governance Attempt 3 Proposal/Vote/Queue/Execute: `0x60ae…211e`, `0x8242…a8c9`, `0x3ce6…bfc5`, `0xeecd…1160`.
6. Evidence IDs: base `ev_aa0b…60bf`, inflow `ev_1fa9…c0d8`, balance `ev_8e74…0095`, Outcome `ev_govout_fd6c…b8d6`.
7. Final safety frame: `HUMAN APPROVAL REQUIRED / true` and `ASSET EXECUTION AUTHORIZED / false`.
