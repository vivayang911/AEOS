...
- **Revised narrated video accepted locally:** human review rejected v3 because variable cue compression produced rushed, pitch-shifted narration at excessive volume. `LOCAL-MANUALS/submission/AEOS-Judge-Mode-180s-Narrated-v4-final.mp4` is the replacement 180-second, 1920×1080 candidate with fixed `1.0` narration playback and `0.42` gain. Normal-speed human review accepted its audio/visual presentation. Strict `ffprobe` codec confirmation and a hosted URL remain pending.
