...
- **Revised narrated video accepted and published:** human review rejected v3 because variable cue compression produced rushed, pitch-shifted narration at excessive volume. The replacement v4 uses fixed `1.0` narration playback and `0.42` gain, passed normal-speed human review and is available at <https://www.youtube.com/watch?v=71CnpHXIdgw>. YouTube oEmbed confirmed URL/title/embed availability; strict `ffprobe` codec confirmation remains a separate local technical check.
